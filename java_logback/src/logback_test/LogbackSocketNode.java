 ...
 * @since 0.8.4
 */
public class LogbackSocketNode implements Runnable {
    ...
    LogbackServer socketServer;

    public LogbackSocketNode(LogbackServer socketServer, Socket socket, LoggerContext context) {
        this.socketServer = socketServer;
        this.socket = socket;
        remoteSocketAddress = socket.getRemoteSocketAddress();
        this.context = context;
        logger = context.getLogger(LogbackSocketNode.class);
    }
