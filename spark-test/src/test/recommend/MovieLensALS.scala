...
object MovieLensALS {
  def main(args:Array[String]) {
    ...
    val args = Array("D:/workspace/git_lab/spark-test/src/test/recommend","D:/workspace/git_lab/spark-test/src/test/recommend/personalRatings.txt");
    ...
    //显示总评分数；总用户数；总电影数
    println("查询出总结果：Got " + numRatings + " ratings from " + numUsers + " users " + numMovies + " movies")
    ...
    println("训练用数据：Training: " + numTraining + " validation: " + numValidation + " test: " + numTest)
